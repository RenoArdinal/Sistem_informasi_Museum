...
<head>
  ...
  <title>Museum Adityawarman Login | Log in</title>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo base_url() . 'assetsadm/dist/css/AdminLTE.css' ?>">
  <!-- iCheck -->
  ...
  <style>
    body.bg-login {
      background: url('<?php echo base_url('assets/img/profil.jpg'); ?>') no-repeat center center fixed;
...
<body class="bg-login">
  <div class="login-box">
    ...
    <div style="border-radius:20px;" class="login-box-body">
      <p class="login-box-msg"> <img style="width:150px;" src="<?php echo base_url('assets/img/museum.png') ?>" alt="" class="img-fluid mb-3"></p>
      <hr />
      ...
      <form action="<?php echo base_url() . 'administrator/auth' ?>" method="post">
        ...
        <div class="mt-3 text-center">
          Kembali ke <a href="<?= base_url('home'); ?>">Beranda</a>
        </div>
      </form>
      ...
      <hr />
      <p>
        <center>Copyright <?php echo '2024' ?> RenoArdinal <br /> UIN Imam Bonjol Padang</center>
      </p>
    </div>
    <!-- /.login-box-body -->
  </div>
