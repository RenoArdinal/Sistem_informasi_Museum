...
<head>
  ...
  <title>Museum Adityawarman | Dashboard</title>
  ...
  <!-- Ionicons -->
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url() . 'assetsadm/plugins/jvectormap/jquery-jvectormap-1.2.2.css' ?>">
  <!-- Theme style -->
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo base_url() . 'admin/portfolio/add_portfolio' ?>"><i class="fa fa-thumb-tack"></i> Tambah Fasilitas</a></li>
              <li><a href="<?php echo base_url() . 'admin/portfolio' ?>"><i class="fa fa-list"></i> Daftar Fasilitas</a></li>
            </ul>
          </li>
